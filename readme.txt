...
<body>
      ...
      <div class="row">
        <div class="col">
          ...
          <div class="choose__bottom">
            <div class="container">
              <div class="row choose__bottom__row">
  ...
  <section class="about">
    <div class="container">
      <div class="row row-top">
        <div class="col-6 col-md-12 col-sm-12 col-left">
          <div>
        ...
        <div class="col-6 col-md-12 col-sm-12 col-right">
          <div>
  ...
  <section class="blog">
    <div class="container">
      ...
      <div class="row row-bottom">
        <div class="col-4 col-lg-4 col-md-6 col-sm-12 mt-5">
          <div class="blog-div">
  ...
  <section class="complete">
    <div class="container">
      ...
      <div class="row row-bottom mt-5">
        <div class="col-10 col-md-12 col-sm-12 mx-auto">
